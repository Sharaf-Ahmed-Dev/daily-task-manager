...
1. ✍️ Type a task in the input field
2. ➕ Click the **Add** button  
   - If the input box is empty, a message **"Please enter a task!"** will appear
...
- 📄 Tasks are dynamically added as `<li>` elements
- 🔁 Clicking a task toggles a `checked` class
